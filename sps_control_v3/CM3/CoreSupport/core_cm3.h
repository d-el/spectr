 ...
 * Return the actual process stack pointer
 */
//extern uint32_t __get_PSP(void); //Storozhenko
 ...
 * (process stack pointer) Cortex processor register
 */
//extern void __set_PSP(uint32_t topOfProcStack); //Storozhenko
 ...
 * Cortex processor register
 */
//extern uint32_t __get_MSP(void); //Storozhenko
 ...
 * (main stack pointer) Cortex processor register
 */
//extern void __set_MSP(uint32_t topOfMainStack); //Storozhenko
 ...
 * Reverse byte order in unsigned short value
 */
//extern uint32_t __REV16(uint16_t value); //Storozhenko
 ...
 */
//extern uint32_t __RBIT(uint32_t value); //Storozhenko
 ...
 */
//extern uint32_t __STREXB(uint8_t value, uint8_t *addr); //Storozhenko
 ...
 */
//extern uint32_t __STREXH(uint16_t value, uint16_t *addr); //Storozhenko
