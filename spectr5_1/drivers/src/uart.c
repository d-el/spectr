...
void uart_init(USART_TypeDef *USARTx, usartBaudRate_type baudRate){
    ...
    if(USARTx == USART1){
        ...
        */
        ...
        //PA9 USART1_TX
        gppin_init(GPIOA, 9, alternateFunctionOutputPushPull, 0);
        //PA10 USART1_RX
        gppin_init(GPIOA, 10, floatingInput, 0);
    ...
    if(USARTx == USART2){
        ...
        */
        RCC->APB2ENR    |= RCC_APB2ENR_IOPAEN;                              //Enable clock for PORTA
        //PA2 USART1_TX
        gppin_init(GPIOA, 2, alternateFunctionOutputPushPull, 0);
        //PA3 USART1_RX
        gppin_init(GPIOA, 3, floatingInput, 0);
    ...
    if(USARTx == USART3){
        ...
        */
        ...
        gppin_init(GPIOB, 10, alternateFunctionOutputPushPull, 0);  //PB10 USART3_TX
        gppin_init(GPIOB, 11, floatingInput, 0);                    //PB11 USART3_RX
        #else
        ...
        gppin_init(GPIOC, 10, alternateFunctionOutputPushPull, 0);  //PC10 USART3_TX
        gppin_init(GPIOC, 11, floatingInput, 0);                    //PC11 USART3_RX
        #endif
        /************************************************
        * NVIC
        */
