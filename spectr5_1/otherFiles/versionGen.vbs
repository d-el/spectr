    ...
    FileOutStream.Write "const uint32_t fwinfo_major    = " + CStr(MajorCurInt) + ";" + vbCrLf
    FileOutStream.Write "const uint32_t fwinfo_minor    = " + CStr(MinorCurInt) + ";" + vbCrLf
    FileOutStream.Write "const uint32_t fwinfo_revision = " + CStr(RevisionCurInt) + ";" + vbCrLf
    FileOutStream.Write "const uint32_t fwinfo_build    = " + CStr(BuildCurInt) + ";" + vbCrLf
    FileOutStream.Write "const char fwinfo_version[] = {""" + CStr(MajorCurInt) + "." + CStr(MinorCurInt) + "." + CStr(RevisionCurInt) + "." + CStr(BuildCurInt) + """};" + vbCrLf
    FileOutStream.Write "const char fwinfo_date[]    = {""" + vDay + "." + vMonth + "." + vYear + " " + vHour + ":" + vMinute + ":" + vSecond + """};" + vbCrLf
